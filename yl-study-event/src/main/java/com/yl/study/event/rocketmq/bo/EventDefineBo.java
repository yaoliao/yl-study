package com.yl.study.event.rocketmq.bo;

import com.yl.study.event.rocketmq.enums.DelayType;
 ...
 * @date 2017/10/30
 */
public class EventDefineBo implements Serializable{

    private static final long serialVersionUID = 4996865207873519147L;
    ...
    public void setDelayTypeInt(Integer delayTypeInt) {
        this.delayTypeInt = delayTypeInt;
        this.delayType = DelayType.getByValue(delayTypeInt);
    }
